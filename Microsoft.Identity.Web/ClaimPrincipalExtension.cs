...
namespace Microsoft.Identity.Web
{
    public static class ClaimsPrincipalExtension
    {
        ...
        /// <summary>
        /// Instantiate a ClaimsPrincipal from an account objectId and tenantId
        /// </summary>
        ...
        public static ClaimsPrincipal FromObjectIdAndTenantId(string objectId, string tenantId)
        {
